...
// storage odcięty – poniższe listy pozostają w pamięci (lub z backendu, gdy będzie gotowy)
function savePatients(_: any) { /* no-op during cutover */ }
...
useEffect(() => {
  ...
  // removed unused statusBadge helper
